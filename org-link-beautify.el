...
(defun org-link-beautify--return-icon (type path extension &optional link-element)
  ...
  (pcase type
    ...
    ("file+emacs" (all-the-icons-icon-for-mode 'emacs-lisp-mode :face '(:foreground "MediumPurple")))
    ("http"  (all-the-icons-icon-for-url (concat "http:"  path) :v-adjust -0.05 :face '(:foreground "green")))
    ("https" (all-the-icons-icon-for-url (concat "https:" path) :v-adjust -0.05 :face '(:foreground "green")))
    ...
    ("elisp" (all-the-icons-icon-for-mode 'emacs-lisp-mode :v-adjust -0.05 :face '(:foreground "SlateBlue1")))
    ("eshell" (all-the-icons-icon-for-mode 'eshell-mode :face '(:foreground "DeepSkyBlue3")))
    ("shell" (all-the-icons-icon-for-mode 'shell-mode :face '(:foreground "DeepSkyBlue3")))
    ...
    ("eww" (all-the-icons-icon-for-mode 'eww-mode :face '(:foreground "DodgerBlue")))
    ...
    ("pdf" (all-the-icons-icon-for-file ".pdf" :face '(:foreground "VioletRed2")))
    ("grep" (all-the-icons-icon-for-mode 'grep-mode :face '(:foreground "maroon4")))
    ("occur" (all-the-icons-icon-for-mode 'occur-mode :face '(:foreground "maroon4")))
